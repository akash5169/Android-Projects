...
public class ExpenseForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = ArrayAdapter.createFromResource(this, R.array.expenceType, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        Spinner sp1 = (Spinner) findViewById(R.id.typeExp);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("this is value of amount" + amount1.getText().toString(), " note " + note1.getText().toString() + " date " + date + " type " + type + " ");
                System.out.println(" " + amount + " " + note);

                SaveExpence saveExpence = new SaveExpence();
                saveExpence.execute(date, amount, type, note);
    ...
    public class SaveExpence extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            databaseOperations.addExpense(db, Date, Amount, Type, Note);
    ...
    public void puDialog(final String Date, final Integer Balance, final Integer amount, final String type, final String note) {
        ...
        myHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        text0.setText(" Amount Spent: " + amount);

                        TextView text2 = (TextView) dialog.findViewById(R.id.text2);
                        text2.setText("Expense Type: " + type);
